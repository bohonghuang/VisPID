...
public class LazyBitmapFont extends BitmapFont {
	...
	public LazyBitmapFont(int fontSize){
		this(GLOBAL_GEN,fontSize, Color.BLACK);
	}
	public LazyBitmapFont(int fontSize, Color fontColor){
		this(GLOBAL_GEN,fontSize, fontColor);
	}
	
	public LazyBitmapFont(FreeTypeFontGenerator generator, int fontSize, Color fontColor) {
		if(generator == null)
		...
		this.parameter.color = fontColor;
		this.data = new LazyBitmapFontData(generator, fontSize, fontColor, this);
		try {
...
//			spaceGlyph.xadvance = (int) data.spaceWidth;
	...
	public static class LazyBitmapFontData extends FreeTypeBitmapFontData {
		...
		public LazyBitmapFontData(FreeTypeFontGenerator generator, int fontSize, Color fontColor, LazyBitmapFont lbf) {
			this.generator = generator;
		...
		protected BitmapFont.Glyph generateGlyph(char ch) {
			...
			Pixmap map = gab.bitmap.getPixmap(Format.RGBA8888, fontColor, 1f);
